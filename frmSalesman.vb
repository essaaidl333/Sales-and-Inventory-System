...
Public Class frmSalesman
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        Try
            If Trim(txtSalesmanID.Text) = "SM-0001" Then
                MessageBox.Show("لا يمكن حذف بيانات المندوب العام", "", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                'txtCity.Focus()
                Exit Sub
            End If
    ...
    Private Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        End If
        If Trim(txtSalesmanID.Text) = "SM-0001" Then
            MessageBox.Show("لا يمكن تعديل بيانات المندوب العام", "", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            'txtCity.Focus()
            Exit Sub
        End If
